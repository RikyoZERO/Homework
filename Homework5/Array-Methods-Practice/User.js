...
// const companyCombo = data.map(
//   user =>
//     `this company offers ${user.company.catchPhrase} and ${user.company.bs}`
// );
...
const emailWebsitePairs = users.map(user => {
  return {
    email: user.email,
    website: user.website
  };
});
console.log("List of Email + Website Pairs:");
